...
aduc = new ADUC();
params = '?rnd=1270016916&site='+ A4Usite +'&cont='+ A4Ucont +'&type='+ A4Utype;
...
if(!aduc.prepared || emerge){
  var imp_beacon_path = "http://log.ad4u.drecom.jp/img/ad_id_194/gen_3/ad4usess_/opt_1/access.gif?timestamp=" + (new Date()).getTime();
  var click_beacon_path = "http://log.ad4u.drecom.jp/img/bt_id_/ad_id_194/ad4usess_/gen_2/click.gif?timestamp=" + (new Date()).getTime();
  ...
  var iframe_tag = '<iframe width="'+ A4Uwidth +'" height="'+ A4Uheight +'" frameborder="0" src="http://grp101.ias.rakuten.co.jp/content/ad/DCBT/delivery/ad/194.html' + params + '" scrolling="no" ></iframe>';
