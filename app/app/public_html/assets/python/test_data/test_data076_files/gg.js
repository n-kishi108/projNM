...
function writeAu()
{
	document.write("<div id=y_gc_div_adcntr class=y_gcss_ovrtr_au><iframe src=\"http://bc.geocities.yahoo.co.jp/bc/gg/i=" + jps + "&u=" + encodeURIComponent(url) + "&ref=" + encodeURIComponent(ref) + "\" width=468 height=77 border=0 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no>no iframe</iframe></div>");
