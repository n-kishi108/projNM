...
aduc = new ADUC();
params = '?rnd=1270017430&site='+ A4Usite +'&cont='+ A4Ucont +'&type='+ A4Utype;
if (typeof(A4Upos) != "undefined"){ params += '&pos='+ A4Upos; }
if (typeof(A4Utg) != "undefined"){ params += '&tg='+ A4Utg;}
params += '&cl='+ A4Uclient +'&domain='+A4Udomain + '&grp=01';

if(!aduc.prepared || emerge){
  var imp_beacon_path = "http://log.ad4u.drecom.jp/img/ad_id_198/gen_1/ad4usess_/opt_1/access.gif?timestamp=" + (new Date()).getTime();
  var click_beacon_path = "http://log.ad4u.drecom.jp/img/bt_id_/ad_id_198/ad4usess_/gen_2/click.gif?timestamp=" + (new Date()).getTime();
  ...
  var iframe_tag = '<iframe width="'+ A4Uwidth +'" height="'+ A4Uheight +'" frameborder="0" src="http://grp101.ias.rakuten.co.jp/content/ad/DCBT/delivery/ad/198.html' + params + '" scrolling="no" ></iframe>';
  document.write(iframe_tag);
};

// volume measurement 0.5%
rnd = parseInt(Math.random()*1000);
if (rnd < 10) {
  document.write('<script type="text/javascript" src="http://ad4u.drecom.jp/delivery/script/197.js"></scr');
  document.write('ipt>');
};
